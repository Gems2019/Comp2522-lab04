...
public class Autobiography extends Biography
{
     ...
     *
     * @param title         The title of the autobiography, must not be null, blank, and less than some  characters.
     * @param yearPublished The year the autobiography was published, must be between year and the current year.
     * @param author        The author of the autobiography, must not be null. The subject will be automatically set
     *                      to this author.
     */
